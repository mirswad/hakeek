...
@section('content')
         <div id="content-wrapper">
            <div class="container-fluid upload-details">
               ...
               <form name="category-form" method="post" action="{{ route('admin.post-category') }}">
                  @csrf
                  <div class="row">
                     <div class="col-sm-6">
                        <div class="form-group">
                           <label class="control-label">Category Name <span class="required">*</span></label>
                           <input class="form-control border-form-control" name="name" value="@if($edit_mode == 'on') {{$category->name}} @endif" placeholder="Category Name" type="text">
                     ...
                     <div class="col-sm-6">
                        <div class="form-group">
                           ...
                           <input class="form-control border-form-control" name="slug" value="@if($edit_mode == 'on') {{$category->slug}} @endif" placeholder="Slug" type="text">
                  ...
                  <input type="hidden" name="edit" value="@if($edit_mode == 'on') 1 @else 0 @endif">
                  @if($edit_mode == 'on')
                  ...
                  <div class="row">
                     <div class="col-sm-12 text-right">
                        ...
                        <button type="submit" class="btn btn-success border-none"> Add Category </button>
                     </div>
                  </div>
               </form>
            </div>
